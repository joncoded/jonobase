...
/app/components/post-grid.tsx
the grid of post "cards"
*/
...
export default function PostGrid({posts} : any) {
  ...
  return (
    <div className="post-grid w-full sm:justify-start">      
      {posts?.length === 0 && 
        <>
      ...
      {posts?.length > 0 && 
        <>  
          ...
          <div className='post-grid-navs flex gap-5 justify-center mt-10 font-sans'>
            <button
