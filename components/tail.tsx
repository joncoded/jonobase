...
export default async function Tail() {  
  ...
  console.log(colophon1, colophon2)
  ...
  return (
    <footer className={`tail-wrapper 
      w-full border-t border-gray-300 bg-gradient-to-b from-black to-gray-900 p-5
    `}>
      <div className={`tail-prop 
        ...
        hover:prose-a:text-white hover:prose-a:underline
      `}>
        <Colophon1 />
        <Colophon2 />
      </div>
